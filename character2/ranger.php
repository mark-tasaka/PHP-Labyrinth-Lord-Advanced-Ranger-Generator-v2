...
<html>
<head>
<title>Advanced Labyrinth Lord Ranger Character Generator Version 2</title>
 
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    
	<meta charset="UTF-8">
	<meta name="description" content="Labyrnith Lord Advance Companion ranger Character Generator..">
...
<body>
    ...
    include 'php/spells.php';
        ...
        {        
            ...
            if(isset($_POST["theConstitution"]))
            {
                ...
                $constitution = rangerConstitutionMin($constitution);
            }       
            ...
            if(isset($_POST["theIntelligence"]))
            {
                ...
                $intelligence = rangerIntelligenceMin($intelligence);
            }  
    ...
    else
    {
        ...
        $druidSpellLevel1 = druidLevel1Spell($level);
        $druidSpellLevel2 = druidLevel2Spell($level);
        $druidSpellLevel3 = druidLevel3Spell($level);

        $magicUserSpellLevel1 = magicUserLevel1Spell($level);
        $magicUserSpellLevel2 = magicUserLevel2Spell($level);
  ...
  <img id="character_sheet"/>
   <section>
       ...
       <span id="savePetrify">
        ...
        <span id="druidSpellLevel1">
            <?php
                echo $druidSpellLevel1;
            ?>
        </span>
        
        <span id="druidSpellLevel2">
            <?php
                echo $druidSpellLevel2;
            ?>
        </span>
        
        <span id="druidSpellLevel3">
            <?php
                echo $druidSpellLevel3;
            ?>
        </span>
        
        
        <span id="magicUserSpellLevel1">
            <?php
                echo $magicUserSpellLevel1;
            ?>
        </span>
        
        <span id="magicUserSpellLevel2">
            <?php
                echo $magicUserSpellLevel2;
            ?>
        </span>
